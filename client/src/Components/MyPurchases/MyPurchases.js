...
export class MyPurchases extends Component {
  render() {
    return (
      <div>
        <div className='w3-show-inline-block' id='groupBtn'>
          <div className='w3-bar'>
            <button className='w3-btn w3' id='purchasesBtn'>
              المبيعات
            </button>

            <button className='w3-btn w3' id='salesCarsBtn'>
              المشتريات
            </button>
          </div>
        </div>
